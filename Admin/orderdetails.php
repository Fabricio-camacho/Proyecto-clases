    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a data-toggle="modal" data-target="#uploadModal"> &nbsp; &nbsp; &nbsp; Actualizar Producto </a></li>
					<li><a href="items.php"> &nbsp; &nbsp; &nbsp; Gestionar Producto </a></li>
					<li><a href="customers.php"> &nbsp; &nbsp; &nbsp; Gestionar Cliente </a></li>
					<li class="active"><a href="orderdetails.php"> &nbsp; &nbsp; &nbsp; Detalles del Pedido </a></li>
        ...
        <div id="page-wrapper">
		 ...
		 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong> Detalles del Pedido </strong> </h3></center>
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				...
				<a class="btn btn-danger" href="?delete_id=<?php echo $row['order_id']; ?>" title="click para eliminar" onclick="return confirm('¿Seguro que quieres eliminar el Producto?')">
				  <span class='glyphicon glyphicon-trash'></span>
				  Eliminar Producto de la Orden</a>
