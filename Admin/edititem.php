	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if($imgFile)
		{
			...
			{			
				...
				{
					$errMSG = "Tu archivo es demaciado grande, tiene que ser menod de 5 MB";
					echo "<script>alert('Tu archivo es demaciado grande, tiene que ser menod de 5 MB')</script>";				
			...
			else
			{
              ...
              echo "<script>alert('Solo se permiten archivos JPG, JPEG, PNG & GIF.')</script>";					
			}	
		}
		else
		{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				$errMSG = "Error no se pudo actualizar !";
