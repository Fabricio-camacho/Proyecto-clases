...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
                <tr>
				 ...
				 <td>
                  <a class="btn btn-block btn-danger" href="?delete_id=<?php echo $row['order_id']; ?>" title="click para eliminar" onclick="return confirm('¿Seguro que quiere eliminar el producto?')"><span class='glyphicon glyphicon-trash'></span> Eliminar Producto </a>
		...
		echo "<td>";
		echo "<a class='btn btn-block btn-success' href='?update_id=".$user_id."' ><span class='glyphicon glyphicon-shopping-cart'></span> Compra Ahora!</a>";
		echo "</td>";
