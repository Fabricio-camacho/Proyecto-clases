	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if($imgFile)
		{
			...
			{			
				...
				{
					$errMSG = "Error tu archivo es demaciado grande, debe ser menor de 5 MB";
					echo "<script>alert('Error tu archivo es demaciado grande, debe ser menor de 5 MB')</script>";				
			...
			else
			{
              ...
              echo "<script>alert('Solo archivos JPG, JPEG, PNG & GIF.')</script>";					
			}	
		}
		else
		{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				$errMSG = "Error los datos no se actualizaron!";
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Carniceria San Alfonso - Panel Administrador</a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a href="logout.php"> &nbsp; &nbsp; &nbsp; Cerrra Sesion </a></li>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	?>
			 <div class="alert alert-info">
                          ...
                          <center> <h3><strong>Actualizar Productos</strong> </h3></center>
